...
from constants.main_page_constants import TEXT_PRICE, TEXT_SEVERAL_SCOOTERS, TEXT_RENTAL_TIME, TEXT_ORDER_FOR_TODAY, TEXT_EXTEND_ORDER, TEXT_CHARGER, TEXT_ORDER_CANCELLATION, TEXT_ORDER_OUTSIDE_MOSCOW, BASE_URL
